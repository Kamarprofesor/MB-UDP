...
# 🚀 اسکریپت مدیریت MB-Udp 🚀

پنل مدیریتی قدرتمند و کاربرپسند برای  MB-Udp. ویژگی‌ها شامل مدیریت کامل کاربران، نظارت بر ترافیک، یکپارچگی WARP، پشتیبانی از ربات تلگرام و پشتیبانی از چندین فرمت اشتراک (ساب لینک) است. نصب ساده با گزینه‌های پیکربندی پیشرفته برای کاربران مبتدی و حرفه‌ای.
...
```
پس از نصب، از دستور `mbudp` برای راه‌اندازی پنل مدیریت استفاده کنید.
...
1. **ویژگی‌های اصلی**
  - نصب و پیکربندی آسان سرور MB-Udp
...
## ⚠️ اعلامیه
این ابزار فقط برای اهداف آموزشی و تحقیقاتی ارائه شده است. کاربران پنل MB-Udp مسئول رعایت موارد زیر هستند:
...
- [تیم هسته MB-Udp](https://github.com/apernet/hysteria)
- اعضای کامیونیتی
...
[![آخرین نسخه](https://img.shields.io/github/v/release/Kamarprofesor/MB-UDP?style=flat-square)](https://github.com/Kamarprofesor/MB-UDP/releases)
[![مجوز](https://img.shields.io/github/license/Kamarprofesor/MB-UDP?style=flat-square)](LICENSE) 
</div>
</div>
