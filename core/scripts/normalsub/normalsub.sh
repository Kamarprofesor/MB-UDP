...
[Service]
ExecStart=/bin/bash -c 'source /etc/hysteria/mb-udp_venv/bin/activate && /etc/hysteria/mb-udp_venv/bin/python /etc/hysteria/core/scripts/normalsub/normalsub.py'
